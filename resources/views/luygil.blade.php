    ...
    <div class="container">
      <nav class="js-mega-menu navbar-nav-wrap">
        ...
        <a class="navbar-brand" href="./index.html" aria-label="Unify">
          <img class="navbar-brand-logo" src="./assets/img/logo_lg.png" alt="Image Description">
        </a>
        <!-- End Default Logo -->
      ...
      <div class="row justify-content-md-center">
        <div class="col-md-8">
          <div class="text-center">
            <img class="avatar avatar-xxl avatar-circle mb-3" src="./assets/img/lg.png" alt="Image Description">

            <div class="mb-4">
              <h3>Lu y Gil</h3>
              <span class="d-block mb-1">Nuestra historia con el paso del tiempo,</span>
              <p>desde cómo empezamos hasta finales de noviembre... continuará!</p>
            </div>
          </div>
        </div>
        <!-- End Col -->
          ...
          <div class="d-grid">
            ...
            <a class="card card-ghost card-transition-zoom" data-fslightbox="youtube-video" href="https://www.youtube.com/watch?v=RJtrzPzodP8">
              <div class="card-transition-zoom-item">
                <img class="card-img" src="./assets/img/1920x1080/abril_lg.png" alt="Image Description">
              </div>

              <div class="card-body">
                <h4>Abril 2021</h4>
                <p class="card-text">Primera cita en Bellevue y nuestro primer beso.</p>
              </div>
            </a>
            <!-- End Card -->
            ...
            <!-- Card -->
            <a class="card card-ghost card-transition-zoom" data-fslightbox="youtube-video" href="https://www.youtube.com/watch?v=fLhjgGUxNoQ">
              <div class="card-transition-zoom-item">
                <img class="card-img" src="./assets/img/1920x1080/noviembre_lg.png" alt="Image Description">
              </div>
